	...
	<div class="index-subpage">
		...
		<div class="swiper-container banner-swiper">
			<ul class="swiper-wrapper">
				<li class="swiper-slide" v-for="(v,i) in bannerArr">
					<img :src="v.imgPath">
				</li>
			</ul>
		...
		setTimeout(()=>{
			...
			this.$http.get('./data/index.json')
			  .then(function (response) {
			    _this.bannerArr=response.data.result.driedFruitlist.bannerArr;
				_this.productArr=response.data.result.driedFruitlist.productArr;
				_this.flag=false;
